...
var Bin = React.createClass({
    ...
    render: function () {
        ...
        return (
            ...
            else if ((compData.packing_box == true) || (compData.packing_box == "true")) {
            ...
            iconToShow = (<div className="tote">
                        {applyClassNameOnTote.search("packingBox-icon") !== -1 ? 
                             <img className={applyClassNameOnTote} src="./assets/images/packing_box_icon.png"></img> :
