...
var LoginPageRevamp = React.createClass({
...
var  ppsDropDown=(
  <select className="selectPPS" value={this.state.getCurrentLang} ref='pps' onChange={this.changeLanguage} >
    ...
    <div className="containerLogin">
        ...
        <main>
        <div className="keyboardLogin"></div>
        <div className="scanIdLogin"></div>
        </main>
        <footer>
        Copyright © 2018 GreyOrange Pte Ltd.
        </footer>
  </div>
    )
  }
...
module.exports = LoginPageRevamp;
