...
function sendFeedback(event, feedback) {
                ...
                <div className="buttonContainer center-block chklstButtonContainer">
                  <div className="row removeBorder feedbackKey">
                    <div
                      ...
                      data-feedback="bad"
                      onClick={sendFeedback.bind(this, "bad")}
                    >
                      <img
                    ...
                    <div
                      ...
                      data-feedback="okay"
                      onClick={sendFeedback.bind(this, "okay")}
                    >
                      <img
                    ...
                    <div
                      ...
                      onClick={sendFeedback.bind(this, "awesome")}
                    >
                      <img
