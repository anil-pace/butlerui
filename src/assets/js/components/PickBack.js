...
var PickBack = React.createClass({
  ...
  getExceptionAction: function (screen_id) {
    switch (screen_id) {
      case appConstants.PICK_BACK_EXCEPTION_REPRINT:
        this._exceptionAction = (
          <Button1
            ...
            color={"orange"}
            module={appConstants.PICK_BACK}
            action={appConstants.REPRINT_INVOICE}
          />
        )
        break
      case appConstants.PICK_BACK_EXCEPTION_SKIP_PRINTING:
        this._exceptionAction = (
          <Button1
            disabled={this.state.PickBackSelectedBin == null}
            text={_("Skip Printing")}
            color={"orange"}
            module={appConstants.PICK_BACK}
            action={appConstants.SKIP_PRINTING}
          />
        )
        break
      case appConstants.PICK_BACK_EXCEPTION_DIS_ASSOCIATE_TOTE:
        ...
        this._exceptionAction = (
          <Button1
            disabled={this.state.PickBackSelectedBin == null}
            text={_("Dis-associate") + " " + toteDisplayName}
            color={"orange"}
            module={appConstants.PICK_BACK}
            action={appConstants.DIS_ASSOCIATE_TOTE}
          />
        )
        break
      case appConstants.PICK_BACK_EXCEPTION_OVERRIDE_TOTE:
        this._exceptionAction = (
          <Button1
            ...
            color={"orange"}
            module={appConstants.PICK_BACK}
            action={appConstants.OVERRIDE_TOTE}
          />
        )
        break
      default:
  ...
  getToteDisplayName: function () {
    ...
    for (
      var i = 0, len = this.state.PickBackExceptionData.list.length;
      i < len;
      i++
    ) {
    ...
    switch (screen_id) {
      case appConstants.PICK_BACK_BIN:
            ...
            <div>
              <div className="cancel-scan">
                <Button1
                  ...
                  text={_("Cancel Scan")}
                  module={appConstants.PICK_BACK}
                  action={appConstants.CANCEL_SCAN_TOTE}
                  color={"black"}
                />
              </div>
            </div>
        ...
        if (this.state.PickBackExceptionStatus == false) {
          this._navigation = (
            <Navigation
              navData={this.state.PickBackNavData}
            ...
            <div className="grid-container">
              {this.state.isPrinterVisible && (
                <div
                  style={{
                    position: "fixed",
                    top: reprintIconStyle.top,
                    left: 0,
                    border: reprintIconStyle.borderColor,
                  }}
                >
                  <img
          ...
          if (this.state.OrigBinUse) {
            binComponent = (
              ...
              >
                ...
                />
                <PackingDetails
                  boxTypeInfo={this.state.PickBackPackingBoxType}
                />
              </div>
            )
          } else {
          ...
          this._component = (
            <div className="grid-container">
              ...
              <BinMap
                ...
                pickFrontSelectedBin={this.state.pickBackSelectedBin}
        ...
        if (this.state.OrigBinUse) {
          binComponent = (
            <div className="exception1">
              <BinsFlex
                dataToDisassociateTote={
                  this.state.PickBackToteDisAssociationData
                }
                binsData={this.state.PickBackBinData}
                screenId={this.state.PickBackScreenId}
                seatType={this.state.SeatType}
              ...
              <div className="packing-Data">
                <div className="packingData-Text">
                  <div className="textLine1">
                    <span className="header">{_("Current Box Barcode")}:</span>
                  ...
                  <div className="textLine2">
                    <span className="header">{_("New Box Barcode")}:</span>
                    <span className="textValue">
                ...
                <div className="packingData-Button">
                  <Button1
                    ...
                    text={_("Back")}
                    module={appConstants.PICK_BACK}
                    action={appConstants.BACK_BUTTON_PRESS}
                    color={"black"}
                  />
                  <Button1
                    ...
                    text={_("Confirm")}
                    module={appConstants.PICK_BACK}
                    action={appConstants.CONFIRM_BUTTON}
                    color={"orange"}
                  />
                </div>
              </div>
            ...
            <div className="row scannerHeader">
              <div className="col-md-6">
                <div className="ppsMode">
                  {" "}
                  PPS Mode : {this.state.PickBackPpsMode.toUpperCase()}{" "}
                </div>
              </div>
              <div className="col-md-6">
                <div className="seatType">
                  {" "}
                  Seat Type : {this.state.PickBackSeatType.toUpperCase()}
                </div>
              </div>
            </div>
  ...
  getNotificationComponent: function () {
    if (this.state.PickBackNotification != undefined) {
      this._notification = (
        <Notification
          notification={this.state.PickBackNotification}
          navMessagesJson={this.props.navMessagesJson}
        />
      )
    } else {
