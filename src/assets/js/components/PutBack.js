...
var PutBack = React.createClass({
  ...
  getToteDisplayName: function() {
    ...
    for (
      var i = 0, len = this.state.PutBackExceptionData.list.length;
      i < len;
      i++
    ) {
  ...
  getScreenComponent: function(screen_id) {
    switch (screen_id) {
      ...
      case appConstants.PUT_BACK_SCAN_TOTE:
        ...
        if (!this.state.StageButtonHideFlag) {
          stageButtonobj = (
            ...
            >
              <Button1
                disabled={!this.state.StageActive}
                text={_("Stage")}
                module={appConstants.PUT_BACK}
                action={appConstants.STAGE_ONE_BIN}
                color={"orange"}
              />
              <Button1
                disabled={!this.state.StageAllActive}
                text={_("Stage All")}
                module={appConstants.PUT_BACK}
                action={appConstants.STAGE_ALL}
                color={"black"}
              />
            </div>
          )
        ...
        if (this.state.PutBackExceptionStatus == false) {
          this._navigation = (
            <Navigation
              navData={this.state.PutBackNavData}
              serverNavData={this.state.PutBackServerNavData}
          ...
          if (this.state.OrigBinUse) {
            binComponent = (
              <BinsFlex
                binsData={this.state.PutBackBinData}
                screenId={this.state.PutBackScreenId}
            ...
            this._modalContent = (
              <ReactModal title={_("Exit LPN")}>
                <div>
                  <div
                    className="row"
                    style={{ fontSize: "1.5em", color: "#4D5055" }}
                  >
                    <div className="col-md-12">
                      <p>
                        {_(
                          "Are you sure you want to exit from {0} LPN and stage all bin(s)?"
                        ).replace("{0}", this.state.ToteId)}
                      </p>
                      <p>
                        {_(
                          "The following {0} items were found missing:"
                        ).replace("{0}", this.state.PutBackMissingItems.length)}
                      </p>
                      <div className="missing-list">
                        ...
                        <div className="list-content">
                          {this.state.PutBackMissingItems.map(function(
                            tuple,
                            idx
                          ) {
                            return (
                              ...
                              >
                                <span className="tuple-row-cell-col-4">
                                  {tuple.product_sku ? tuple.product_sku : "--"}
                                </span>
                                <span className="tuple-row-cell-col-4">
                                  {tuple.label ? tuple.label : "--"}
                                </span>
                                <span className="tuple-row-cell-col-4">
                                  {tuple.quantity ? tuple.quantity : "--"}
                                </span>
                              </section>
                            )
                          })}
                      ...
                      <div className="row removeBorder">
                        <div className="col-md-6">
                          <Button1
                            ...
                            color={"orange"}
                            status={true}
                            barcode={this.state.PutBackInvoiceId}
                            module={appConstants.PUT_BACK}
                            action={appConstants.CONFIRM_CLOSE_INVOICE}
                          />
                        </div>
                        <div className="col-md-6">
                          <Button1
            ...
            <div className="grid-container">
              ...
              this.state.InvoiceRequired.invoiceFlag ? (
                <div className="gor-invoice-put-back">
                  ...
                  <span className="gor-invoice-put-back-h2">
                    {this.state.ToteId}
                  </span>
                </div>
              ) : (
              ...
              {this.state.InvoiceRequired &&
              this.state.InvoiceRequired.invoiceFlag &&
              screen_id === appConstants.PUT_BACK_STAGE ? (
                <div className="cancel-scan">
                  <Button1
                    disabled={false}
                    text={utils.frntStringTransform(
                      "FRNT.PBI.02",
                      invoiceStringArgExitBtn
                    )}
                    module={appConstants.PUT_BACK}
                    action={appConstants.EXIT_INVOICE}
                    color={"black"}
                  />
                </div>
              ) : (
      ...
      case appConstants.PUT_BACK_INVOICE:
        ...
        invoiceStringArg[0] = this.state.InvoiceType
        var componentModalString = utils.frntStringTransform(
          "FRNT.PBI.01",
          invoiceStringArg
        )
        this._navigation = ""
          ...
          if (this.state.OrigBinUse) {
            binComponent = (
              <div className="binsFlexWrapperContainer">
                ...
                />
                <WrapperSplitRoll
                  scanDetails={this.state.PutBackScanDetails}
                  productDetails={this.state.PutBackProductDetails}
                  itemUid={this.state.PutBackItemUid}
                />
              </div>
            )
          } else {
            ...
            <div className="grid-container">
              ...
              this.state.InvoiceRequired.invoiceFlag ? (
                <div className="gor-invoice-put-back">
                  {utils.frntStringTransform("FRNT.PBI.03", invoiceStringArg)}{" "}
                  <span className="gor-invoice-put-back-h2">
                    {this.state.InvoiceRequired.invoiceId}
                  </span>
                </div>
              ) : (
                ""
              ...
              <div className="cancel-scan">
                <Button1
                  ...
                  barcode={this.state.PutBackItemUid}
                  color={"black"}
                />
              </div>
            </div>
            ...
            <div className="grid-container audit-reconcilation">
              ...
              <div className="staging-action">
                <Button1
                  ...
                  text={_("BACK")}
                  module={appConstants.PUT_BACK}
                  toteId={this.state.PutBackToteId}
                  status={false}
                  action={appConstants.CANCEL_TOTE}
                  color={"black"}
                />
                <Button1
                  disabled={false}
                  ...
                  toteId={this.state.PutBackToteId}
                  status={true}
                  action={appConstants.CLOSE_TOTE}
                  color={"orange"}
                />
              </div>
            </div>
            ...
            <div className="grid-container exception">
              ...
              <div className="exception-right">
                ...
                <div className="main-container exception1">
                  <Img
                    srcURL={this.state.PutBackExceptionProductDetails.image_url}
                  />

                  <TabularData
                    data={this.state.PutBackExceptionProductDetails}
                  />
                ...
                <div className="finish-damaged-barcode">
                  <Button1
                    disabled={
                      this.state.PutBackKQDetails.current_qty == 0 ||
                      !Number.isInteger(
                        Number(this.state.PutBackKQDetails.current_qty)
                      )
                    }
                    text={_("NEXT")}
                    color={"orange"}
                    module={appConstants.PUT_BACK}
                    action={appConstants.FINISH_EXCEPTION_ENTITY_DAMAGED}
                  />
                </div>
              </div>
              <div className="cancel-scan">
              ...
              <div className="exception-right">
                ...
                <div className="finish-damaged-barcode">
                  <Button1
                    ...
                    color={"orange"}
                    module={appConstants.PUT_BACK}
                    action={appConstants.FINISH_EXCEPTION_ITEM_OVERSIZED}
                  />
                </div>
              </div>
              <div className="cancel-scan">
        ...
        this._component = (
          <div className="grid-container exception">
            ...
            <div className="exception-right">
              ...
              <div className="finish-damaged-barcode">
                <Button1
                  disabled={this.state.PutBackNextButtonState}
                  text={_("NEXT")}
                  color={"orange"}
                  module={appConstants.PUT_BACK}
                  action={appConstants.SEND_EXCESS_ITEMS_BIN}
                />
              </div>
            </div>
            <div className="cancel-scan">
              ...
              <div className="exception-right">
                ...
                <div className="finish-damaged-barcode">
                  <Button1
                    ...
                    color={"orange"}
                    module={appConstants.PUT_BACK}
                    action={appConstants.FINISH_EXCEPTION_EXTRA_ITEM}
                  />
                </div>
              </div>
              <div className="cancel-scan">
      ...
      case appConstants.PUT_BACK_EXCEPTION_ENITY_IRT_BIN:
        ...
        if (this.state.GetExceptionType == appConstants.PHYSICALLY_DAMAGED) {
          ...
          this.state.GetExceptionType == appConstants.TOTE_UNSCANNABLE
        ) {
          messageIRTenable = (
            <div className="gor-exceptionConfirm-text">
              {_("Please put unscannable tote in IRT bin and scan the bin")}
            </div>
          )
          messageIRTdisable = (
            <div className="gor-exceptionConfirm-text">
        ...
        if (!this.state.GetIRTScanStatus) {
              ...
              <div className="gor-exception-align">
                ...
                <div className="finish-damaged-barcode align-button">
                  <Button1
                    ...
                    color={"orange"}
                    module={appConstants.PUT_BACK}
                    action={appConstants.PUT_FINISH_EXCEPTION_ENTITY}
                  />
                </div>
              </div>
            </div>
          ...
          selected_screen = (
            <div className="exception-right">
              <div className="gor-exception-align">{messageIRTenable}</div>
            </div>
          )
        }
        this._component = (
            ...
            <div className="exception-right">
              ...
              <div className="finish-damaged-barcode">
                <Button1
                  ...
                  color={"orange"}
                  module={appConstants.PUT_BACK}
                  action={appConstants.CONFIRM_ITEM_PLACE_IN_IRT}
                />
              </div>
            </div>
            <div className="cancel-scan">
      ...
      case appConstants.PUT_BACK_INVALID_TOTE_ITEM:
        ...
        this._component = (
          <div className="grid-container audit-reconcilation">
            ...
            <Reconcile
              navMessagesJson={this.props.navMessagesJson}
              message={this.state.PutBackToteException}
            />
            <div className="staging-action">
              <Button1
                disabled={false}
                ...
                module={appConstants.PUT_BACK}
                status={true}
                action={appConstants.CANCEL_TOTE_EXCEPTION}
                color={"black"}
              />
              <Button1
                disabled={false}
                ...
                module={appConstants.PUT_BACK}
                status={true}
                action={appConstants.CONFIRM_TOTE_EXCEPTION}
                color={"orange"}
              />
            </div>
          </div>
            ...
            <div className="row scannerHeader">
              <div className="col-md-6">
                <div className="ppsMode">
                  {" "}
                  PPS Mode : {this.state.PutBackPpsMode.toUpperCase()}{" "}
                </div>
              </div>
              <div className="col-md-6">
                <div className="seatType">
                  {" "}
                  Seat Type : {this.state.PutBackSeatType.toUpperCase()}
                </div>
              </div>
            </div>
  ...
  getNotificationComponent: function() {
    if (this.state.PutBackNotification != undefined) {
      this._notification = (
        <Notification
          notification={this.state.PutBackNotification}
          navMessagesJson={this.props.navMessagesJson}
        />
      )
    } else {
