        ...
        if (this.state.PutFrontExceptionStatus == false) {
          if (
            ...
            binComponent = (
              ...
              >
                <BinsFlex
                  binsData={this.state.PutFrontBinData}
          ...
          this._component = (
            <div className="grid-container exception">
              <Modal />
              <Exception
                data={this.state.PutFrontExceptionData}
                action={true}
              />
              <div className="exception-right"></div>
              <div className="cancel-scan">
          ...
          this._component = (
            <div className="grid-container">
              ...
              <div
                className={
                  "single-bin" +
                  (this.state.SplitScreenFlag ? " gor-fixed-position" : "") +
                  (this.state.SplitScreenFlag ? "" : " fix-top")
                }
              >
                <CurrentActiveBin
                  selected={true}
              ...
              <div className="main-container adjust-main-container">
                <Rack
                  ...
                  rackData={this.state.PutFrontRackDetails}
                  putDirection={this.state.PutFrontPutDirection}
          ...
          selected_screen = (
            <div>
              <div className="kq-exception">
                <div className="gor-info-text">
                  {_("Empty the rollcage to undock")}
                </div>
              </div>
              <div className="staging-action">
                <Button1
                  disabled={this.state.PutFrontExceptionFlag}
                  text={_("Confirm")}
                  module={appConstants.PUT_FRONT}
                  action={appConstants.WAREHOUSEFULL_EXCEPTION}
                  color={"orange"}
                />
              </div>
            </div>
        ...
        if (this.state.PutFrontExceptionStatus == false) {
          ...
          this._component = (
            <div className="grid-container">
              ...
              >
                <Bins
                  binsData={this.state.PutFrontCurrentBin}
                  screenId={this.state.PutFrontScreenId}
                />
        ...
        if (this.state.PutFrontExceptionStatus == false) {
          ...
          this._component = (
            <div className="grid-container">
              ...
              <div
                className={
                  "single-bin" + (this.state.SplitScreenFlag ? "" : " fix-top")
                }
              >
                <Bins
                  binsData={this.state.PutFrontCurrentBin}
      ...
      case appConstants.PUT_FRONT_EXCEPTION_DAMAGED_ENTITY:
        ...
        _button = (
          <div className="staging-action">
            <Button1
              ...
              text={_("Confirm")}
              module={appConstants.PUT_FRONT}
              action={appConstants.UNMARKED_DAMAGED}
              color={"orange"}
            />
          </div>
        )
        if (isUnmarked) {
          ...
          unmarkedContainer = (
            <div>
              <TabularData
                data={this.state.PutFrontDamagedItems}
        ...
        this._component = (
          <div className="grid-container exception">
            ...
            <div className="exception-right">
              ...
              <div className="finish-damaged-barcode">{_button}</div>
            </div>
            <div className="cancel-scan">
              <Button1
                disabled={false}
              ...
              <div className="exception-right">
                ...
                <div className="finish-damaged-barcode">
                  <Button1
                    ...
                    color={"orange"}
                    module={appConstants.PUT_FRONT}
                    action={appConstants.GET_REVISED_QUANTITY}
                  />
                </div>
              </div>
              <div className="cancel-scan">
            ...
            <div className="row scannerHeader">
              <div className="col-md-6">
                <div className="ppsMode">
                  {" "}
                  PPS Mode : {this.state.PutFrontPpsMode.toUpperCase()}{" "}
                </div>
              </div>
              <div className="col-md-6">
                <div className="seatType">
                  {" "}
                  Seat Type : {this.state.PutFrontSeatType.toUpperCase()}
                </div>
              </div>
            </div>
        ...
        if (this.state.PutFrontExceptionStatus == false) {
          ...
          this._component = (
            <div className="grid-container">
              ...
              <div className="main-container udp-flow">
                <CheckList
                  checklistData={this.state.PutFrontChecklistData}
        ...
        if (this.state.PutFrontIsCrossDockEnabled === true) {
          ...
          this._subComponent = (
            <div className="single-bin udp-flow">
              ...
              <PreviousDetails
                previousDetails={this.state.PreviousDetails}
                customizeClass={"customize_WaitingForMsu_UdpFlow"}
                type="put"
              />
            </div>
          )
                ...
                <div>
                  <div className="row">
                    <div className="col-md-12">
                      <p>
                        {_(
                          "Are you sure that all the items in the cart were scanned?"
                        )}
                      </p>
                      <p>
                        {_(
                          "The following {0} items were found missing"
                        ).replace("{0}", this.state.missingItemList.length)}
                      </p>
              ...
              <ReactModal title={_("Unexpected Item")}>
                <div>
                  <div className="row">
                    <div className="col-md-12">
                      <div className="title-textbox">
                        {_(
                          "Unexpected item found. Put item in IRT bin and confirm"
                        )}
                      </div>
                    </div>
                  </div>
                  <div className="modal-footer removeBorder">
                    <div className="buttonContainer center-block chklstButtonContainer">
                      <div className="row removeBorder">
                        <div className="unex-close-text col-md-4 col-md-offset-3">
                          <Button1
                            disabled={false}
                            text={_("Close")}
                            color={"black"}
                            module={appConstants.PUT_FRONT}
                            action={appConstants.CLOSE_UNEXPECTED_SCAN}
                          />
                        </div>
                      </div>
                    </div>
