...
var STNInput = React.createClass({
    ...
    render: function (data) {
        var applyClassName, showErrorMsg, invoiceStringArg = [];
        ...
        if (this.props.errorFound && this.props.errorFound.level === "error" ?
            (applyClassName = "inputWrapper showError", showErrorMsg = errorMsg) :
