...
var navData = {
  ...
  pickFront: [
    [
      {
        screen_id: [
          ...
          "pick_front_one_step_scan",
          "pick_front_dock_tote",
          "pick_front_undock_tote",
          "pick_front_slot_scan",
          "pick_front_tote_confirm"
        ],
        code: "Common.000",
        message: "Wait For MSU",
        showImage: false,
    ...
    [
      {
        screen_id: [
          "pick_front_location_scan",
          "pick_front_container_scan",
          "pick_front_item_scan",
          "pick_front_more_item_scan",
          "pick_front_container_break",
          "pick_front_checklist",
          "pick_front_skip_tote",
          "pick_front_skip_bin"
        ],
        code: "Common.000",
        image: svgConstants.scan,
