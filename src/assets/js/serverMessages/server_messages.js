var serverMessages = {
    ...
    "CLIENTCODE_010" : "Put quantity should be equal to sum of damaged, missing and good",
    "CLIENTCODE_011" : "Pick quantity should be equal to sum of damaged, missing and good ",
