...
function server_messages_list() {
   _("No more entities to be scanned");
    ...
    _("{0} excess entities found in {0}. Please put entities in exception area and confirm");
    _("Entity not expected in {0}. Please put entity in exception area and confirm");
