var spanish = {
	...
	"All scan and print will be cancelled. Confirm to cancel?": "Se cancelar\u00e1n todos los escaneos e impresiones. \u00bfConfirmar para cancelar?",
	"Are You Sure You Want to Close Tote?": "\u00bfEst\u00e1 seguro que desea cerrar la Bolsa?",
	"Are you sure you want to cancel the exception?": "\u00bfEst\u00e1 seguro de querer cancelar la excepci\u00f3n?",
	"Are you sure you want to close Tote": "Est\u00e1 seguro que desea cerrar la Bolsa",
	...
	"Bad barcode on pack": "C\u00f3digo de barras incorrecto en el paquete",
	"Bad barcode on sub pack": "C\u00f3digo de barras incorrecto en el paquete secundario",
	...
	"Bin": "Recipiente",
	"Bin Already Scanned": "Contenedor ya escaneado",
	...
	"Bin full": "Contenedor lleno",
	"Bin scan successful": "Escaneo de contenedor realizado con \u00e9xito",
	...
	"Container Already Scanned.": "Contenedor ya escaneado.",
	"Continue": "Continuar",
	"Continue scanning Sub-Packs and Pack": "Continuar escaneando paquetes principales y paquetes secundarios",
	...
	"DO NOT STACK": "NO APILE",
	"Damage Barcode": "C\u00f3digo de barras da\u00f1ado",
	"Damaged Quantity": "Cantidad da\u00f1ada",
	"Damaged and missing entity recorded.": "Art\u00edculos da\u00f1ados y faltantes registrados.",
	"Damaged sub pack": "Paquete secundario da\u00f1ado",
	...
	"Enter Quantity of Unscannable Pack": "Introducir cantidad del paquete no apto para escaneo",
	"Enter Quantity of Unscannable Sub-Pack": "Introducir cantidad del paquete secundario no apto para escaneo",
	...
	"Entities cannot be accommodated!": "\u00a1Las entidades no pueden ser introducidas!",
	...
	"Entity entry successful": "Entrada de entidad realizada con \u00e9xito",
	...
	"Exception with entity reported": "Excepci\u00f3n con entidad reportada",
	...
	"Extra details entered are incorrect.Please enter correct details": "Los detalles adicionales introducidos son incorrectos. Introduzca los detalles correctos.",
	"Extra entity scan found.": "Escaneo de entidad adicional encontrada.",
	...
	"Good pack": "Paquete en buen estado",
	"Good sub pack": "Paquete secundario en buen estado",
	...
	"Invalid Entity Scanned.": "Entidad Inv\u00e1lida Escaneada.",
	"Invalid Event.Expecting PPTL button press": "Prueba inv\u00e1lida. Esperando pulsar tecla PPTL",
	...
	"Issue with MPU": "Problema con la MPU",
	"Issue with Pack": "Problema con el paquete",
	"Issue with Sub pack": "Problema con el paquete secundario",
	"Issues with entity": "Problemas con entidad",
	...
	"Last item scan will be cancelled. Do you want to continue?": "El \u00faltimo escaneo de art\u00edculo ser\u00e1 cancelado. \u00bfDesea continuar?",
	"Length of {0} should not be greater than {1}": "La longitud de {0} no deber\u00eda mayor a {1}",
	...
	"No Sub-Packs to reconcile": "Sin paquetes secundarios para conciliar",
	...
	"PPS is closed": "PPS est\u00e1 cerrado",
	...
	"Pack Scan Successful": "Escaneo del paquete realizado correctamente",
	"Pack Unscannable": "No es posible escanear este paquete",
	"Pack missing": "Falta el paquete",
	"Pack scan successfully": "Escaneo del paquete realizado correctamente",
	"Packing box scan failed": "Error al escanear la caja de embalaje",
	"Packs": "Paquetes",
	"Password": "Contrase\u00f1a",
	...
	"Physically Damaged Reported should equal Scanned Quantity": "El da\u00f1o f\u00edsico reportado deber\u00eda ser equivalente a la cantidad escaneada",
	"Physically Damaged entity reported.": "Da\u00f1o f\u00edsico de la entidad reportado.",
	"Pick box from MSU and press PPTL on Bin {0}": "Seleccione el cuadro de MSU y presione PPTL en el contenedor {0}",
	...
	"Please put damaged entities in IRT bin and scan the bin": "Por favor, deposite las entidades da\u00f1adas en el contenedor IRT y escanee el contenedor",
	...
	"Please put entities which have issues in exception area": "Coloque las entidades que tienen problemas en el \u00e1rea de excepci\u00f3n",
	...
	"Please put exception entities in exception area": "Por favor, deposite las entidades de excepci\u00f3n en la zona de excepci\u00f3n",
	"Please put extra entities in IRT bin and scan the bin": "Por favor, deposite las entidades adicionales en el contenedor IRT y escanee el contenedor",
	"Please put extra entities in exception area": "Por favor, deposite las entidades adicionales en la zona de excepci\u00f3n",
	"Please put extra entities in exception area.": "Por favor, ponga los art\u00edculos no escaneables en la zona de excepci\u00f3n.",
	"Please put oversized entities in IRT bin and scan the bin": "Por favor, deposite las entidades extra grandes en el contenedor IRT y escanee el contenedor",
	"Please put oversized entities in exception area": "Por favor, deposite las entidades extra grandes en la zona de excepci\u00f3n",
	"Please put oversized entities in exception area.": "Por favor, ponga los art\u00edculos extra grandes en la zona de excepci\u00f3n.",
	"Please put unscannable entities in IRT bin and scan the bin": "Por favor, deposite las entidades no escaneables en el contenedor IRT y escanee el contenedor",
	"Please put unscannable entities in exception area": "Por favor, deposite las entidades no escaneables en la zona de excepci\u00f3",
	...
	"Print": "Imprimir",
	"Processing Next Pick from Rack ": "Procesando la Selecci\u00f3n Siguiente de Estante",
	...
	"Put Pack list in trolley and press PPTL to confirm": "Coloque la lista de paquetes en el carro y presione PPTL para confirmar",
	"Put pack list in trolley and press PPTL to confirm": "Coloque la lista de paquetes en el carro y presione PPTL para confirmar",
	"Quantity of Physically damaged entities scanned is less.": "La cantidad escaneada de las entidades da\u00f1adas f\u00edsicamente es menor",
	...
	"Remove Tote from bin & Press PPTL to confirm no Items Remaining": "Eliminar Totalizador del contenedor y Pulsar PPTL para confirmar que no hay Elementos Restantes",
	...
	"Reprint": "Reimpresi\u00f3n",
	"SKU not present in Database.": "SKU no est\u00e1 presente en la Base de Datos.",
	...
	"Scan Damaged Entity": "Escanear Entidad Da\u00f1ada",
	...
	"Scan Pack or Sub-Packs": "Escanear paquete o paquetes secundarios",
	...
	"Scan Small Box": "Escanear una caja peque\u00f1a",
	...
	"Scan a packing box and keep in bin {0}": "Escanear una caja de embalaje y mantenerla en el contenedor {0}",
	...
	"Scan excess item quantity": "Escanear la cantidad excedida de art\u00edculos",
	...
	"Scan not Allowed. PPS close/force close or profile change requested.": "Escaneo no permitido. Cerrar/forzar cierre PPS o cambio de perfil solicitado.",
	...
	"Scan {0} Box and Place in Bin {1}": "Escanear {0} una caja y colocarla en el contenedor {1}",
	...
	"Scan {0} Small Box and Place in Bin {1}": "Escanear {0} una caja peque\u00f1a y colocarla en el contenedor {1}",
	"Scan {0} items": "Escanee {0} art\u00edculos",
	"Scan {0} more packs and place in bin {1}": "Escanear {0} m\u00e1s paquetes y colocarlos en el contenedor {1}",
	"Scan {0} more sub packs and place in bin {1}": "Escanear {0} m\u00e1s paquetes secundarios y colocarlos en el contenedor {1}",
	"Scan {0} packs": "Escanear {0} paquetes",
	"Scan {0} sub packs": "Escanear {0} paquetes secundarios",
	...
	"Sub pack missing": "Falta el paquete secundario",
	"Sub-Pack Unscannable": "No es posible escanear este paquete secundario",
	"Sub-Pack scan successfully": "Escaneo del paquete secundario realizado correctamente",
	"Sub-Packs": "Paquetes secundarios",
	"Submit": "Enviar",
	"Sum of good and exception quantity should be equal to {0}": "La suma de art\u00edculos y la cantidad de excepciones debe ser igual a {0}",
	"Sum of good, missing and damaged should be equal to {0}": "La suma de art\u00edculos, desapariciones y da\u00f1os debe ser igual a {0}",
	...
	"Waiting for Bins to be Cleared at Pick Front": "Esperando Contenedores para despejado en Parte Delantera",
	...
	"Warehouse Full": "Dep\u00f3sito lleno",
	"Warehouse Full Remove all entities from bin & press PPTL": "Dep\u00f3sito Lleno. Eliminar todas las entidades del contenedor y pulsar PPTL",
	...
	"Wrong Scan. Entity not present in Database": "Escaneo incorrecto. Entidad no presente en la Base de Datos",
	"Wrong Scan. IRT bin scan expected": "Escaneo incorrecto. Escaneo de contenedor IRT en espera",
	"Wrong Scan. Unrecognized barcode.": "Escaneo incorrecto. C\u00f3digo de barras no recocido.",
	...
	"Wrong entity Scanned. Bin Scan Expected.": "Escaneada una entidad incorrecta. Se espera el escaneo del contenedor.",
	"Wrong entity scan.Please scan the correct entity": "Escaneo de entidad incorrecto.Por favor, escanee la entidad correctamente",
	...
	"type.": "tipo.",
	"user Name": "Nombre de usuario",
	"{0} Physically damaged entity recorded.WMS notified": "{0} Entidad f\u00edsicamente da\u00f1ada registrada. WMS notificado",
