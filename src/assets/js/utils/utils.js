...
var putSeatData = function(data) {
    ...
    switch (data.state_data.mode + "_" + data.state_data.seat_type) {
        ...
        case appConstants.AUDIT:
            ...
            //data.state_data=JSON.parse('{"seat_name":"front_1","notification_list":[],"rack_details":{"rack_type_rec":[["A",[[["01","02"],120,105,100]]]],"slot_barcodes":["104.0.A.01","104.0.A.02"],"slot_type":"slot"},"exception_allowed":[],"k_deep_audit":true,"roll_cage_flow":false,"show_expected_qty":false,"bin_coordinate_plotting":false,"event":"finish_audit","screen_id":"audit_front_waiting_for_mpu","last_finished_box":[],"Cancel_scan":true,"logout_allowed":true,"Sku_Item_List":[],"product_info":[],"time_stamp":"1505226443","api_version":"1","mode":"audit","Box_qty_list":[{"Box_Actual_Qty":9,"Expected_qty":36,"Box_Expected_Qty":3,"Box_serial":"SUBPACK","Type":"outer/pack","Actual_qty":0,"Scan_status":"no_scan"},{"Box_Actual_Qty":4,"Expected_qty":36,"Box_Expected_Qty":3,"Box_serial":"PACK","Type":"outer/pack","Actual_qty":0,"Scan_status":"no_scan"},{"Box_Actual_Qty":9,"Expected_qty":36,"Box_Expected_Qty":3,"Box_serial":"PACK","Type":"outer/pack","Actual_qty":3,"Scan_status":"no_scan"}],"group_info":{"1":"center"},"scan_allowed":false,"Extra_box_list":[{"Box_serial":"A000000067","Expected_qty":0,"Actual_qty":2,"Scan_status":"close","Type":"inner/subpack"},{"Box_serial":"A000000067","Expected_qty":0,"Actual_qty":2,"Scan_status":"close","Type":"outer/pack"}],"seat_type":"front","Current_box_details":[],"item_in_box_barcode_damage":[],"extra_loose_sku_item_list":[],"screen_version":"1","enable_kq":false,"loose_item_barcode_damage":0,"docked":[],"Loose_sku_list":[],"is_idle":false,"box_barcode_damage":[{"type":"inner/subpack","damage_count":4},{"type":"outer/pack","damage_count":4}],"header_msge_list":[{"level":"info","code":"AdF.H.006","details":[],"description":"Check Count"}]}');
